 ...
 *
 *   <div id="workflow-workbench-root" data-report-url="/r/<sha>/data?token=…"></div>
 *
...
const MOUNT_ID = "workflow-workbench-root";
...
function boot() {
  ...
  if (!reportUrl) {
    el.textContent = "workflow-workbench island: missing data-report-url";
    return;
  }
