 ...
 *
 *   <div id="workflow-spec-root" data-report-url="/r/<sha>/data?token=…"></div>
 *
...
const MOUNT_ID = "workflow-spec-root";
...
function boot() {
  ...
  if (!reportUrl) {
    el.textContent = "workflow-spec island: missing data-report-url";
    return;
  }
